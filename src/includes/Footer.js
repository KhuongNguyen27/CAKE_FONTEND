            ...
            <div className="footer-widget-wrapper d-flex flex-wrap gap-4">
              ...
              <div className="footer-widget flex-grow-1">
                ...
                <ul className="footer-widget__link">
                  <li>
                    <a href="shop.html">Cupcake</a>
                  </li>
                  <li>
                    <a href="shop.html">Pastry</a>
                  </li>
                  <li>
                    <a href="shop.html">Muffin</a>
                  </li>
                  <li>
                    <a href="shop.html">Waffle</a>
                  </li>
                </ul>
              </div>
              {/* Footer Widget End */}
              ...
              <div className="footer-widget flex-grow-1">
                ...
                <ul className="footer-widget__link">
                  ...
                  <li>
                    <a href="blog-details.html">Latest Post</a>
                  </li>
                  <li>
                    <a href="about.html">Selling Tips</a>
                  </li>
                </ul>
              </div>
              {/* Footer Widget End */}
      ...
      <div className="container">
        <div className="row row-cols-1 align-items-center">
          <div className="col">
            ...
            <ul className="footer-payment justify-content-center">
              <li>
                <svg
          ...
          <div className="col">
            ...
            <div className="footer-copyright-text text-center">
              <p>
                © 2022 <strong> Bakerfresh </strong> Made with{" "}
                <i className="lastudioicon-heart-1" /> by{" "}
